<div class="row">
    <div class="col-md-8">
        ...
        {{ Form::text('translatable[storefront_footer_menu_2_title]', trans('storefront::attributes.storefront_footer_menu_2_title'), $errors, $settings) }}
        {{ Form::select('storefront_footer_menu_2', trans('storefront::attributes.storefront_footer_menu_2'), $errors, $menus, $settings) }}
    </div>
</div>
