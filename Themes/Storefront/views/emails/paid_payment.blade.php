...
<head>
    ...
    <head>
        <title>invoice #{{$payment_order->order->id}}</title>
                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            ...
                                            <p>Pembayaran Anda sudah <strong>berhasil</strong>. Kami akan segera
                                            ...
                                            @if($payment_order->type != 'down_payment')
                                            <!-- Action -->
                                            <table class="body-action" align="center" width="100%" cellpadding="0"
                                                cellspacing="0" role="presentation">
                                                <tr>
                                                    <td align="center">
                                                        <a href="{{url('account/invoice/'.$payment_order->order->id)}}"
                                            ...
                                            <table class="address" width="100%" cellpadding="0" cellspacing="15"
                                                ...
                                                <tr>
                                                    <td>
                                                        <p class="f-fallback">
                                                            {{ $payment_order->order->billing_full_name }}
                                                            <br>
                                                            {{ $payment_order->order->billing_address_1 }}
                                                            <br>
                                                            {{ $payment_order->order->billing_address_2 }}
                                                            <br>
                                                            {{ $payment_order->order->billing_city }}, {{ $payment_order->order->billing_state_name }}
                                                            {{ $payment_order->order->billing_zip }}
                                                            <br>
                                                            {{ $payment_order->order->billing_country_name }} </p>
                                                    </td>
                                                    <td>
                                                        <p class="f-fallback">
                                                            {{ $payment_order->order->shipping_full_name }}
                                                            <br>
                                                            {{ $payment_order->order->shipping_address_1 }}
                                                            <br>
                                                            {{ $payment_order->order->shipping_address_2 }}
                                                            <br>
                                                            {{ $payment_order->order->shipping_city }},
                                                            {{ $payment_order->order->shipping_state_name }} {{ $payment_order->order->shipping_zip }}
                                                            <br>
                                                            {{ $payment_order->order->shipping_country_name }}</p>
                                                    </td>
                                                </tr>
                                            </table>
