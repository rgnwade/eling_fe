            ...
            <form method="POST" action="{{ route('register.post') }}">
                ...
                <div class="box-wrapper register-form">
                    <div class="box-header">
                        <h4>{{ trans('user::auth.customer_registration') }}</h4>
                    </div>
                    <div class="form-inner clearfix">
                        <div class="col-md-12">
                            <div class="form-group {{ $errors->has('first_name') ? 'has-error': '' }}">
                                ...
                                <div class="radio" >
                                    <input type="radio" name="register_type" value="customer_b2c" id="customer_b2c"
                                        v-model='register_type'>
                                    <label for="customer_b2c" style="margin-right: 30px">{{ trans('user::auth.personal') }}</label>

                                    <input type="radio" name="register_type" value="customer" id="customer"
                                        v-model='register_type'>
                                    <label for="customer">{{ trans('user::auth.corporate') }}</label>
