            ...
            <div class="wrapper">
                <div class="left-sidebar clearfix">
                    <ul class="list-inline">
                        <li class="<?php echo e(request()->is('install/pre-installation') ? 'active' : 'complete'); ?>">
                            Pre-Installation
                        </li>

                        <li class="<?php echo e(request()->is('install/configuration') ? 'active' : ''); ?> <?php echo e(request()->is('install/complete') ? 'complete' : ''); ?>">
                            Configuration
                        </li>

                        <li class="<?php echo e(request()->is('install/complete') ? 'complete' : ''); ?>">
                            Complete
                        </li>
                    </ul>
                </div>
...
<?php /**PATH C:\xampp\htdocs\FleetCart_Old\resources\views/install/layout.blade.php ENDPATH**/ ?>