                ...
                <div class="col-md-8">
                    ...
                    <?php if($footerMenu2->isNotEmpty()): ?>
                        <div class="col-sm-3">
                            <div class="row">
                                <div class="links">
                                    <div class="mobile-collapse">
                                        <h4><?php echo e(setting('storefront_footer_menu_2_title')); ?></h4>
                                    </div>
                    ...
                    <div class="col-sm-3">
                            <div class="row">
                                <div class="links">
                                    <div class="mobile-collapse">
                                        <h4><?php echo e(trans('storefront::account.links.shipping_payment')); ?></h4>
                                    </div>

                                    <ul class="list-inline">
                                            <img style="max-width:100%" src="<?php echo e($shippingPayment); ?>">
                                    </ul>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\FleetCart_Old\Themes\Storefront\views/public/partials/footer.blade.php ENDPATH**/ ?>