...
<script type="text/javascript">
    var chatAdmins = <?php echo json_encode(chat_admins()); ?>


window.applozic.init({
    appId: '<?php echo e(config('app.applozic')); ?>',
    userId: "<?php echo e(Auth::user()->uuid); ?>",
    accessToken: "<?php echo e(Auth::user()->api_token); ?>",
    userName: "<?php echo e(Auth::user()->first_name. ' ' . Auth::user()->last_name); ?>",
    imageLink : '',
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\fleetcart\Themes\Storefront\views/public/partials/chat.blade.php ENDPATH**/ ?>