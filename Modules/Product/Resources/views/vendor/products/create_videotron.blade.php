...
@slot('title',trans('product::vendor.create_videotron'))
...
<div class="accordion-content clearfix">
    <div class="accordion-box-content col-lg-12 col-md-6">
        <div class="tab-content clearfix">
            ...
            <form method="POST" action="{{ route('vendor.products.store_videotron') }}" class="form-vertical"
                id="product-create-form" validate>
                {{ csrf_field() }}
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 ">
                        {{ Form::numberVertical('vendor_price', 'price / meters', $errors, $product, [  'step'=>'0.01','required' => true, 'placeholder' => trans('product::vendor.price')]) }}
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3">
                        {{ Form::numberVertical('minimum_order', trans('product::vendor.minimum_order_meter'), $errors, $product, [ 'step'=>'0.01', 'required' => true, 'placeholder' => 'Minimum Order (Meters)']) }}
                    </div>
                    <div class="col-lg-3 col-md-3 ">
