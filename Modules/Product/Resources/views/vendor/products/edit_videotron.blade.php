...
@slot('title',trans('product::vendor.edit_videotron'))
...
<div class="accordion-content clearfix">
    <div class="accordion-box-content col-lg-12 col-md-6">
        <div class="tab-content">
            ...
            <form method="POST" action="{{ route('vendor.products.update_videotron', $product) }}" class="form-vertical"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 ">
                        {{ Form::numberVertical('vendor_price', trans('product::vendor.price'), $errors, $product, [  'step'=>'0.01', 'required' => true, 'placeholder' => trans('product::vendor.price')]) }}
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3">
                        {{ Form::numberVertical('minimum_order',trans('product::vendor.minimum_order_meter'), $errors, $product, [  'step'=>'0.01', 'required' => true, 'placeholder' => trans('product::vendor.minimum_order')]) }}
                    </div>
                    <div class="col-lg-3 col-md-3 ">
                        {{ Form::selectVertical('stock_product_status_id', trans('product::vendor.stock_status'), $errors, $stock_status, $product) }}
                    </div>
                    <div class="col-lg-3 col-md-3">
                        {{ Form::numberVertical('weight', trans('product::vendor.weight_meter'), $errors, $product, [ 'step'=>'0.01', 'required' => true, 'placeholder' => trans('product::vendor.weight_meter')]) }}
                    </div>
                </div>
                <label control-label="">Cabinet Details</label>
                <div class="row">

                    <div class="col-lg-3 col-md-3">
                        {{ Form::numberVertical('cabinet_depth',  trans('product::vendor.depth_meter'), $errors, $product, ['step'=>'0.01',  'required' => true, 'placeholder' => trans('product::vendor.depth_meter')]) }}
                    </div>

                    <div class="col-lg-3 col-md-3">
                        {{ Form::numberVertical('cabinet_length', trans('product::vendor.length_meter'), $errors, $product, ['step'=>'0.01',  'required' => true, 'placeholder' => trans('product::vendor.length_meter')]) }}
                    </div>

                    <div class="col-lg-3 col-md-3">
                        {{ Form::numberVertical('cabinet_width',  trans('product::vendor.width_meter'), $errors, $product, ['step'=>'0.01',  'required' => true, 'placeholder' => trans('product::vendor.width_meter')]) }}
                    </div>
                </div>
                <div class="row">
        ...
        <div class="modal-footer">
            <button type="submit" value="Submit"
                onclick="return confirm('{{ trans("product::vendor.on_edit_alert") }}?')"
