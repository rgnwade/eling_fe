@section('content')
    <div class="row">
        <div class="btn-group pull-right">
            @if(auth()->user()->hasAccess('vendor.products.create_videotron'))
                <a href="{{ route("vendor.{$resource}.create_videotron") }}" class="btn btn-primary btn-actions btn-create">
                    {{ trans('product::vendor.create_videotron') }}
                </a>
            @endif
