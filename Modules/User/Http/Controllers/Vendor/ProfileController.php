...
use Modules\User\Http\Requests\UpdateProfileVendorRequest;
...
class ProfileController extends Controller
{
    ...
    public function edit()
    {
        ...
        return view('user::vendor.profile.edit', compact('tabs'));
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateProfileVendorRequest $request)
    {
    ...
    public function getGoogle2Fa()
    {
        ...
        $qr = $google2fa->getQRCodeInline(
         ...
         return view('user::vendor.google2fa.index', compact('qr','secret' ));
    }
