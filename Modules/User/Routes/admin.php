...
Route::get('login_admin', 'AuthController@getLogin')->name('admin.login');
...
Route::get('google2fa', 'ProfileController@getGoogle2Fa')->name('admin.google2fa');
Route::post('google2fa', 'ProfileController@postGoogle2Fa')->name('admin.google2fa.post');
