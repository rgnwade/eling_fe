...
@section('content')
  <div class="container">
    ...
    <form method="POST" action="{{ route('admin.google2fa.post') }}" class="form-horizontal" id="profile-form" novalidate>
        {{ csrf_field() }}
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">{{trans('admin::resource.enable', ['resource' => trans('user::users.google2fa')])}}</div>
                    ...
                    @if(empty($currentUser->google2fa_secret))
                        <div class="row">
                            ...
                            <div class="form-group row col-lg-6">
                                    ...
                                    {{trans('admin::resource.enable', ['resource' => trans('user::users.google2fa')])}}
                                </button>
